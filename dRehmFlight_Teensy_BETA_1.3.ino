...
float Kp_roll_angle = 0.35;    //Roll P-gain - angle mode 
float Ki_roll_angle = 0.01;    //Roll I-gain - angle mode
float Kd_roll_angle = 0.0;   //Roll D-gain - angle mode (has no effect on controlANGLE2)
float B_loop_roll = 0.3;      //Roll damping term for controlANGLE2(), lower is more damping (must be between 0 to 1)
float Kp_pitch_angle = 0.35;   //Pitch P-gain - angle mode
...
float B_loop_pitch = 0.3;     //Pitch damping term for controlANGLE2(), lower is more damping (must be between 0 to 1)

float Kp_roll_rate = 0.20;    //Roll P-gain - rate mode
float Ki_roll_rate = 0.5;     //Roll I-gain - rate mode
float Kd_roll_rate = 0.001;  //Roll D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
float Kp_pitch_rate = 0.2;   //Pitch P-gain - rate mode
float Ki_pitch_rate = 0.5;    //Pitch I-gain - rate mode
float Kd_pitch_rate = 0.001; //Pitch D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)

float Kp_yaw = 0.3;           //Yaw P-gain
float Ki_yaw = 0.03;          //Yaw I-gain
float Kd_yaw = 0.00003;       //Yaw D-gain (be careful when increasing too high, motors will begin to overheat!)
